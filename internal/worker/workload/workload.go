...
// the SessionManager. It returns the manager so the caller can pass it
// to agentctl as the EventHandler.
func Start(d StartDeps) *SessionManager {
	mgr := NewSessionManager(d.Log, d.CtlURL, d.CtlSecret, d.Drivers...)

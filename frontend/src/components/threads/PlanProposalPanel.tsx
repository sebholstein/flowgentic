...
import type { ParsedPlan } from "@/lib/thread-state";
...
export function PlanProposalPanel({ plan, onApprove, onReject }: PlanProposalPanelProps) {
  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <div className="flex items-center gap-2 border-t px-4 py-3">
        ...
        <Button size="sm" variant="outline" className="flex-1 gap-1.5" onClick={onReject}>

...
export function ThreadChangesPanel({ patchData, comments: initialComments }: ThreadChangesPanelProps) {
  const changedFiles = Object.keys(patchData);
  ...
  if (changedFiles.length === 0) {
    return (
      <div className="h-full flex items-center justify-center text-muted-foreground">
        No file changes in this thread yet.
      </div>
    );
  }
            ...
            return (
              ...
              >
                <PatchDiff
                  ...
                  unsafeCSS={`:host { --diffs-font-size: 11px; --diffs-line-height: 16px; }`}
